...
**Минусы:** засыпает через 15 мин без трафика (первый запрос после сна ~30 сек). SQLite файл теряется при редеплое — для постоянных данных нужен Render Disk (платно).
...
**Минусы:** ограниченный бесплатный кредит, потом платно.
...
[TimeWeb](https://timeweb.cloud) | [Beget](https://beget.com) | [Reg.ru](https://reg.ru) | [Selectel](https://selectel.ru)
...
| Россия, без проблем | **TimeWeb** | Простая панель, рублёвая оплата |
